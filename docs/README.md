...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-09-13 21:09:22 UTC<br>状态：成功</p>
</section>
...
<p>今日速读2篇6.0分论文，聚焦自我改进系统与奖励记忆驱动因子挖掘。最值得关注MetaRSI/RSI2提出的递归自我改进框架，以及AlphaRJM用奖励跳跃记忆指导随机收益下的Alpha发现。普通读者可先浏览这两篇的摘要与方法示意图，判断是否与自身研究或投资场景相关。</p>
  </div>
</section>
...
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="MetaRSI / RSI2: A Meta-Recursive Self-Improving System for Recursive Self-Improving Systems Themselves">MetaRSI / RSI2: A Meta-Recursive Self-Improving System for Recursive Self-Improving Systems Themselves</span></li><li><span class="dpr-home-dashboard-paper-title" title="AlphaRJM: Reward-Jump Memory for Stochastic Return-Guided Alpha Discovery">AlphaRJM: Reward-Jump Memory for Stochastic Return-Guided Alpha Discovery</span></li></ul>
  </div>
