...
<p>今天精读 3 篇、速读 0 篇，其中《A JEPA Recipe for Tabular Foundation Models》以 9.0 分领跑，《AutoData: Agentic Search for Pre-training Data Selection》获 8.0 分。</p>
<p>最值得看的是表格基础模型的 JEPA 训练方案，以及用智能体搜索来挑选预训练数据这条新路径。</p>
<p>普通读者可先读 9.0 分那篇了解表格模型的自监督思路，再顺着 8.0 分那篇看数据筛选如何自动化。</p>
  </div>
</section>
<section class="dpr-home-dashboard-card dpr-home-deep-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="A JEPA Recipe for Tabular Foundation Models">A JEPA Recipe for Tabular Foundation Models</span></li><li><span class="dpr-home-dashboard-paper-title" title="AutoData: Agentic Search for Pre-training Data Selection">AutoData: Agentic Search for Pre-training Data Selection</span></li><li><span class="dpr-home-dashboard-paper-title" title="Learning to Fluctuate: Statistical Foundations for Causal Tabular Pretraining">Learning to Fluctuate: Statistical Foundations for Causal Tabular Pretraining</span></li></ul>
  </div>
