...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-09-07 22:52:18 UTC<br>状态：成功</p>
</section>
...
<p>今日精读5篇论文，重点聚焦大模型蒸馏与技术报告。</p>
<p>最值得关注的是《Mitra-v2 Technical Report》（10分）对系统架构的完整披露，以及《Rethinking On-Policy Distillation II》（9分）针对“单个训练示例”的重新审视。</p>
<p>建议普通读者优先浏览Mitra-v2报告中的设计结论，再结合蒸馏文章理解样本效率对训练的影响。</p>
  </div>
</section>
<section class="dpr-home-dashboard-card dpr-home-deep-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Mitra-v2 Technical Report">Mitra-v2 Technical Report</span></li><li><span class="dpr-home-dashboard-paper-title" title="Rethinking On-Policy Distillation of Large Language Models II: One Training Example">Rethinking On-Policy Distillation of Large Language Models II: One Training Example</span></li><li><span class="dpr-home-dashboard-paper-title" title="SMILE: Bridging Continuous Optimization and Discrete Symbolic Recovery">SMILE: Bridging Continuous Optimization and Discrete Symbolic Recovery</span></li></ul>
  </div>
  <div class="dpr-home-dashboard-tags"><span class="dpr-home-dashboard-tag">sr <strong>2</strong></span><span class="dpr-home-dashboard-tag">tabular-fm <strong>2</strong></span><span class="dpr-home-dashboard-tag">opd <strong>1</strong></span></div>
</section>
