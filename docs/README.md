...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-09-21 22:51:41 UTC<br>状态：成功</p>
</section>
...
<p>今日精读1篇、速读1篇：MOSAIC-SR以10.0满分领跑，AutoData以6.0跟进。</p>
<p>最值得看的是MOSAIC-SR用Transformer引导符号回归来恢复科学方程，代表AI辅助科学发现的方向；速读可关注AutoData用智能体搜索做预训练数据筛选的思路。</p>
<p>建议普通读者优先读MOSAIC-SR了解方法全貌，再按需扫读AutoData的数据选择逻辑。</p>
  </div>
</section>
<section class="dpr-home-dashboard-card dpr-home-deep-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="MOSAIC-SR: Transformer-Guided Symbolic Regression for Scientific Equation Recovery">MOSAIC-SR: Transformer-Guided Symbolic Regression for Scientific Equation Recovery</span></li></ul>
  </div>
...
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="AutoData: Agentic Search for Pre-training Data Selection">AutoData: Agentic Search for Pre-training Data Selection</span></li></ul>
  </div>
