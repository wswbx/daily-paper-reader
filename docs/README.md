...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-09-14 22:10:48 UTC<br>状态：成功</p>
</section>
...
<p>2026-09-14日报：3篇论文中精读2篇，主攻表格基础模型注意力量化与表格时序偏移下的自适应边界。</p>
<p>最值得看的是9.0分的《Attention Quantization for Tabular Foundation Models》，其次是8.0分的《The Anatomy and Boundary of Adaptation under Temporal Tabular Shift》。</p>
<p>普通读者可先读9分那篇了解表格基础模型的注意力量化，再按需跟进8分那篇的时序自适应边界。</p>
  </div>
</section>
<section class="dpr-home-dashboard-card dpr-home-deep-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Attention Quantization for Tabular Foundation Models">Attention Quantization for Tabular Foundation Models</span></li><li><span class="dpr-home-dashboard-paper-title" title="The Anatomy and Boundary of Adaptation under Temporal Tabular Shift">The Anatomy and Boundary of Adaptation under Temporal Tabular Shift</span></li></ul>
  </div>
...
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="MetaRSI / RSI2: A Meta-Recursive Self-Improving System for Recursive Self-Improving Systems Themselves">MetaRSI / RSI2: A Meta-Recursive Self-Improving System for Recursive Self-Improving Systems Themselves</span></li></ul>
  </div>
