...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-09-22 22:11:34 UTC<br>状态：成功</p>
</section>
...
<p>今日精读2篇、速读1篇共3篇论文，Causilo技术报告以满分领跑。最值得关注因果推断新框架Causilo与可即插即用的表格基础模型特征筛选方案PACE，均偏实用落地。建议普通读者先看Causilo了解因果方法全貌，再用PACE尝试低成本特征筛选。</p>
  </div>
</section>
<section class="dpr-home-dashboard-card dpr-home-deep-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Causilo Technical Report">Causilo Technical Report</span></li><li><span class="dpr-home-dashboard-paper-title" title="PACE: Plug-and-Play Contextual Embedding for Feature Screening with Pretrained Tabular Foundation Models">PACE: Plug-and-Play Contextual Embedding for Feature Screening with Pretrained Tabular Foundation Models</span></li></ul>
  </div>
...
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Enhancing Transformer Representations of Symbolic ODE Expressions">Enhancing Transformer Representations of Symbolic ODE Expressions</span></li></ul>
  </div>
